...
#conda create --name hongweihuangsystem python=3.8
#conda activate hongweihuangsystem
#pip install Pillow
...
def open_main_interface():
    ...
    button_agv_management = tk.Button(root, text="AGV货运小车管理", command=lambda: subprocess.run(["python", r"C:\\Users\\xingkong\\Desktop\\hongweihuang_system\\agvplan.py"]))
    button_agv_management.pack(pady=10)

    button_dock_management = tk.Button(root, text="码头装卸管理", command=lambda: subprocess.run(["python", r"C:\\Users\\xingkong\\Desktop\\hongweihuang_system\\matouzhuangxie.py"]))
    button_dock_management.pack(pady=10)

    button_crane_management = tk.Button(root, text="吊机管理", command=lambda: subprocess.run(["python", r"C:\\Users\\xingkong\\Desktop\\hongweihuang_system\\Crane_management.py"]))
    button_crane_management.pack(pady=10)

    button_goods_identification = tk.Button(root, text="货物煤炭识别", command=lambda: subprocess.run(["python", r"C:\\Users\\xingkong\\Desktop\\hongweihuang_system\\Goods_identification.py"]))
...
bg_image_path = r"C:\\Users\\xingkong\\Desktop\\hongweihuang_system\\matou2.png"
...
label_footer = tk.Label(root, text="made by hongweihuang", font=("Arial", 10), bg="white")
label_footer.pack(side=tk.BOTTOM, pady=10)
